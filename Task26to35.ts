...
// Task30
let usernames: string[] = ["admin","Asim", "Qasim", "Hasnain", "Kashif", "Hashmi"];
...
// Task31
let newusernames: string[] = ["Asim", "Qasim", "Hasnain", "Kashif", "Hashmi", "admin"];
...
let current_users: string[] = ["Ali", "kashif", "hamza", "Qasim", "toseer"];

// List of new users
let new_users: string[] = ["kashif", "hashmi", "Ali", "Ahmad", "saeed"];
...
//    Task34
let pizzas: string[] = ["Chicken Fajita", "Tikka Boti", "Pepperoni"];
