...
// Task 16
let newguestArr = ["Qasim", "kashif", "Hashmi", "Hasnain"];
...
let guestaddbeg = "Hamza";
newguestArr.unshift(guestaddbeg);
//  console.log( newguestArr)
let guestaddmidlle = "Hammad";
...
// Task17
let guestsList = ["Qasim", "Kashif", "Hashmi", "Hasnain", "Saeed"];
...
let placesToVisit = ["Karachi", "Balouchistan", "America", "Hyderabad", "Mirpurkas"];
...
// Task20
let countries = ["Pakistan", "China", "Japan", "India", "Dubai"];
